...
namespace BookStore.Api.Controllers
{
    ...
    public class bBookServiceController : ControllerBase
    {
        ...
        public string BuyBook(string bookName)
        {
            ...
            IList<IFilterMetadata> metadata = new List<IFilterMetadata>();
            AuthorizationFilterContext context= new AuthorizationFilterContext(Acontext,metadata);
            ClaimsIdentity identity = context.HttpContext.User.Identity as ClaimsIdentity;
            string owner = identity.FindFirst("Name")!.Value;
